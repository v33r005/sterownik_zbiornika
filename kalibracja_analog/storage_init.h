...
//****************************************************************
  ...
  if (cfg->getUInt32(PARAM1, &max_zawor)) {} else {}
  if (cfg->getUInt32(PARAM2, &min_zawor)) {} else {}
  if (cfg->getUInt32(PARAM3, &min_pompa)) {} else {}
  ...
  if (cfg->getUInt32(PARAM8, &Sygnal_Alarmu)) {} else {}
